...
* Remove unused `aggregate` function

### geodata/cutout.py
* Remove unused import statements
* Remove reference to runoff
* Remove unused matrix functions
* Add comments to suppress lint error warnings generated by Pylance in VSCode (no bearing on code functionality)

### geodata/dataset.py
* Remove unused import statements
* Remove obsolete reference to CDS API (CDS API functions now in era5.py)
* Remove unused matrix functions

### geodata/era5.py
* Replace hardcoded value for `product_type` in api function

### geodata/merra2.p7
* Remove unused import statements
* Add initialization of `fd` in `else` statement of api function to satisfy Pylance lint error
* Remove unneeded comments

### geodata/preparation.py
* Remove unused import statements
* Add comments to suppress lint error warnings generated by Pylance in VSCode (no bearing on code functionality)

### geodata/pv/irradiation.py
* Remove unused import statements

### geodata/pv/solar_panel_model.py
* Remove unused import statements

### geodata/pv/solar_position.py
* Remove unused import statements
...
### example_notebooks/
* Rename `tests/` to `example_notebooks/`
* Move example notebooks in `doc/jupyter_notebooks` to `example_notebooks`
* Remove redundant Merra2 test files in favor of future testing setup

### example_notebooks/era5.ipynb
* Re-add missing data download step to ERA5 example notebook that was causing errors (ref to issue https://github.com/east-winds/geodata/issues/49)
* Minor changes to step descriptions to bring notebook to same level of detail as `merra2.ipynb`

### .gitignore
* Ignore `.csv` files generated by example notebooks
